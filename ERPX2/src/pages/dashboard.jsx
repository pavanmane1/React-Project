        ...
        <div className="w-full sm:w-4/5 md:w-1/2 lg:w-1/3 xl:w-1/3 shadow-lg bg-white p-3 rounded-xl">
          <form className="space-y-6 p-4">
            ...
            <div className='flex items-center justify-center'>
              <button className="w-1/5 mr-5 p-2 border bg-blue-600 text-white border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-500 transition duration-150 flex items-center justify-center">
