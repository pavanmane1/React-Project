...
const utilityStyle = {
    ...
    shadowContainer: "w-full sm:w-4/5 md:w-1/2 lg:w-1/3 xl:w-1/3 shadow-lg bg-white p-2 rounded-xl",
    ...
    titleTextStyle: "text-gray-900 text-shadow-sm font-semibold text-2xl sm:text-4xl md:text-3xl lg:text-3xl text-center leading-tight tracking-wide transition-all duration-500 ease-in-out transform hover:scale-105",
